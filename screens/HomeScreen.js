	...
	return (
		<View style={styles.container}>
			<ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
				<View>
					<Table />
					<Button title={'Add Item'} onPress={createItem.bind('Apple')} />
				</View>
			</ScrollView>
...
createItem = (item) => {
	// find item on DB
	// if not found:
	//   prompt user to manually type the expiary date
	//   calculate the duration of item
	//   add the new item to DB
	//   cre

	// create alertNotification on the appropriate date
	return 0;
};
